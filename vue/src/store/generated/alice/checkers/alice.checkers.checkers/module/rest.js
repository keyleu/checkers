...
export class Api extends HttpClient {
    constructor() {
         ...
         * @request GET:/alice/checkers/checkers/canPlayMove
         */
        this.queryCanPlayMove = (query, params = {}) => this.request({
            path: `/alice/checkers/checkers/canPlayMove`,
            method: "GET",
            query: query,
            format: "json",
            ...params,
         ...
         * @request GET:/alice/checkers/checkers/playerInfo
         */
        this.queryPlayerInfoAll = (query, params = {}) => this.request({
            path: `/alice/checkers/checkers/playerInfo`,
            method: "GET",
            query: query,
            format: "json",
            ...params,
         ...
         * @request GET:/alice/checkers/checkers/playerInfo/{index}
         */
        this.queryPlayerInfo = (index, params = {}) => this.request({
            path: `/alice/checkers/checkers/playerInfo/${index}`,
            method: "GET",
            format: "json",
            ...params,
        });
